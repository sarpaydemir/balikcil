# Instruction — watcher-high · 2026-09-19 08:45 UTC · Ingrid · round 1 · batch 01

## Role

`watcher-high` · you are **Ingrid** · field of view: **exchange behaviour** ·
...
- The 34 cards of batch 01, listed in `data/card-order/batches/batch-01.md`,
  and no other card.
- Within each card, your field of view only: **changes in the funding rate and the payment interval; listing, delisting and warning announcements; every administrative decision the exchange takes.**
...
Write to `notes/2026-09-19-ingrid-batch01.md` and write nothing else, anywhere.
