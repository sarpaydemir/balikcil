# Instruction — watcher-high · 2026-09-19 07:20 UTC · round 1 · price itself

## Role

`watcher-high` · watcher · **field of view: price itself** · **round 1**.
...
- The ten cards `cards/C001.md` … `cards/C010.md`, and nothing else under
  `cards/`.
- Within each card, your field of view only: **price, volume, trade count,
...
- `notes/` — you write into it and read nothing from it.
...
Write to `notes/2026-09-19-round1-price-high.md` and write nothing else, anywhere.
