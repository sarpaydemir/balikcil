# Identity audit — card set `blinded-strict-flags`
...
| field | value |
|---|---|
| run number (RULES 29) | `ba8d6b5e3880f9ee` |
| full input fingerprint | `ba8d6b5e3880f9ee91f778bb4c48b3121738480e89f3ce98e3229180c8ad7d03` |
| written at (system clock, UTC, RULES 23) | 2026-09-19T14:10:47Z |
| free disk space at start (bytes) | 16111861760 |
| card folder | `exam-prep/blind-proof/strict-flags/cards` |
| cards | 306 |
| distinct coins | 10 |
...
| `ALL` | 31 | 0.251634 | 0.169935 | YES | 0.517869 | 0.514677 | YES |
| `ALL-except-frozen-volatility` | 28 | 0.22549 | 0.169935 | YES | 0.51483 | 0.514439 | YES |
