# Blinding manifest — card set `rank`
...
| field | value |
|---|---|
| run number (RULES 29) | `35df01d621d8da5a` |
| full input fingerprint | `35df01d621d8da5a295c4e246780f8474acc66024816588182b1d7a543d6abb2` |
| written at (system clock, UTC, RULES 23) | 2026-09-19T14:08:28Z |
| free disk space at start (bytes) | 16111931392 |
| source cards | `cards`, 306 cards |
| configuration | `levels=rank;btceth=drop;funding=summary;takerbuy=centred;p7=full;ratio_dp=3` |
...
| the 306 blinded cards, combined | `00a428658914e43da1e1372c08844488dd6bcec69bfa192a280668efdcbc3a14` |
